...
<body>
    <div align="center">
        ...
        <h3>Make sure that you have an outstanding loan and that your bank balance balance exceeds the requested repayment amount</h3>
        <a href='/'>Home</a>
    </div>
</body>